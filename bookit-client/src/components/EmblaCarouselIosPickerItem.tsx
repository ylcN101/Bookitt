...
export const IosPickerItem: React.FC<PropType> = (props) => {
	const { slideCount, perspective, loop = true } = props
	...
	const rotateWheel = useCallback(
		(emblaApi: EmblaCarouselType) => {
			...
			const scrollPosition = emblaApi.scrollProgress()
			const selectedSnap = Math.round(scrollPosition * slideCount)
			props.onSelectedSlideChange(selectedSnap)
		},

		[slideCount, rotationOffset]
	)
